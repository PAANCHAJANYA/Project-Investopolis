...
$(".myProfileButton").click(function()
{
    ...
    $("#investor1content").css("display","none");
    $("#investor2content").css("display","none");
    $("#profileInfo").css("display","block");
});
$("#investor1").click(function()
{
    $("#profileInfo").css("display","none");
    $("#investor2content").css("display","none");
    $("#investor1content").css("display","block");
    $("#myProfilePage .nav-section a").removeClass("nav__link--active");
    $("#investor1 a").addClass("nav__link--active");
});
$("#investor2").click(function()
{
    $("#profileInfo").css("display","none");
    $("#investor1content").css("display","none");
    $("#investor2content").css("display","block");
    $("#myProfilePage .nav-section a").removeClass("nav__link--active");
    $("#investor2 a").addClass("nav__link--active");
});
